		...
		do {
			...
			switch (option) {
				...
				case 2:
					...
					System.out.println(String.format("%d: %s -------- %s\n\t%s\n", topic.getSize(), msg.getDate(), msg.getAuthor(), msg.getMessage()));
					Console.WaitMessage();
					break;
				
				case 3:
					System.out.println("\nDeleting a message...");
					int index = Console.Integer("Enter message id#> ");
					
					if (topic.getSize()-1 < index) {
						System.out.println("Index is out of bounds.");
						Console.WaitMessage();
						break;
					}
					
					msg = topic.getMessageIDX(index);
					
					System.out.println("Removed message: \n");
					System.out.println(String.format("%d: %s -------- %s\n\t%s\n", topic.getSize(), msg.getDate(), msg.getAuthor(), msg.getMessage()));
					
					
					topic.removeMessage(index);
